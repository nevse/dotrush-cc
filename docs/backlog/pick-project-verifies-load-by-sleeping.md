---
worth: later
where: plugins/dotrush/skills/dotrush-pick-project/SKILL.md:60
added: 2026-09-17
---
# pick-project verifies the load by sleeping

Step 7 says "wait a few seconds (large solutions take longer), then run documentSymbol". The dxvcs session got
